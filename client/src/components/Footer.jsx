  ...
  return (
    ...
    <footer className="bg-slate-800 dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="mb-6 md:mb-0">
                <a href="/" className="flex items-center">
                    ...
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-gray-500">Dress<strong className='text-white'>Zone</strong></span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Information</h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between text-white">
            <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Yugantha Polhengoda™</a>. All Rights Reserved.
            </span>
