    ...
    <div className='titillium-web-regular border-t-2 px-[5%] md:px-[9%] lg:px-[5%] xl:px-[9%] pt-32 lg:pt-20 pb-40 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col lg:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='bg-slate-60 max-w-[425px] overflow-hidden'>

            <button onClick={toggleSizeChartVisibility} className='inline-flex float-end gap-0 pt-2'>
              <IoIosSettings size={19} className={`ml-4 text-blue-600 transition-all ${isSizeChartVisible ? 'rotate-[180deg] transition-[60s]' : ''}`} />
              <span className='text-[13px]'>Size Chart</span>
            </button>
            <img src={SizeChart} className={`w-[425px] mt-7 translate-x-[425px] transition-transform duration-500 ease-in-out ${isSizeChartVisible ? '-translate-x-[-1px] opacity-100' : ''} flex items-center justify-center `}/>
            ...
            <div className='flex flex-col gap-4 my-4 md:my-8'>
              ...
              <div className='md:flex gap-[71px] '>
                <div className={`relative mt-3 lg:mt-6 mb-2 ${isSizeChartVisible ? '-z-10' : ''}`}>
                ...
                <div>
                <p className='lg:mt-5 mt-7 text-2xl font-semibold'><span className='text-gray-600'>Price:</span> <span className=''>{currency}{productData.price}</span></p>
                <p className='text-xs text-gray-400'>Shipping and taxes extra</p>
                </div>
              </div>
